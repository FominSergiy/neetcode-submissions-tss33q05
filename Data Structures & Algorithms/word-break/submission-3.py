class Solution:
    def wordBreak(self, s: str, wordDict: List[str]) -> bool:
        ...
        # BOTTOM UP
        n = len(s)
        # n + 1 needed because this builds an exclusive size up to n + 1 -> meaning n is available
        # otherwise if size n -> then idx n will not be available
        dp = [False] * (n + 1)
        dp[n] = True # base case - once we cleared ALL the words at all idx
